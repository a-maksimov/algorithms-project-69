...
def test_search_with_spam():
    doc1 = """The Great Pacific Garbage Patch is a collection of marine debris in the North Pacific Ocean. Marine debris is litter that ends up in oceans, seas, and other large bodies of water. 
...
"""
    doc2 = """At the time of sampling, there were more than 1.8 trillion pieces of plastic in the patch that weigh an estimated 80,000 tonnes. These figures are much higher than previous calculations.
...
"""
    ...
    docs = [
        {'id': 'garbage_patch_NG', 'text': doc1},
        {'id': 'garbage_patch_ocean_clean', 'text': doc2},
        {'id': 'garbage_patch_wiki', 'text': doc3},
        {'id': 'garbage_patch_spam', 'text': doc4},
    ]

    assert search(docs, 'the trash island is a') == [
        "garbage_patch_NG",
